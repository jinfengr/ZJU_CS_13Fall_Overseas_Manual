...
\draw[fill=white,opacity=.6] (1cm,0) rectangle (9.5cm,-7.5cm);
\node[anchor=north west] at (1cm,.25cm) {\parbox[t][9.5cm][t]{7.7cm}{\huge\bfseries\flushleft \printcontents{l}{1}{\setcounter{tocdepth}{1}}}};
