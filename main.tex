...
\noindent 贡献者（排名不分先后）：张逸萌，饶锦锋，俞涛，王九零 % License information

\noindent \textit{模版改编自 The Legrand Orange Book}\\% Printing/edition date
\textit{背景照片供稿自廖宇晗} % Printing/edition date
...
\chapterimage{zjg_campus} % Table of contents heading image
...
\chapterimage{zjg_campus} % Chapter heading image
